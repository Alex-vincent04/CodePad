...
class Task(BaseModel):
    ...
    code: Optional[str] = None  # Store submitted code (for backend)
    html: Optional[str] = None  # For frontend
    css: Optional[str] = None   # For frontend
    js: Optional[str] = None    # For frontend
